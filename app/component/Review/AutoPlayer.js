...
//                     <div key={index} className="flex-col-1 gap-6 p-5 mb-5">
//                         <div className="flex shadow-2xl bg-white rounded-3xl justify-center p-3 items-center gap-5">
//                             <div className="w-1/2">
//                                 <img
...
//                             </div>
//                             <div className="mx-auto">
//                                 <h1 className="text-[14px] font-semibold flex">
//                                     {rev.title}{" "}
//                                     <span>
//                                         {" "}
//                                         <img
//                                             className="w-[100px] ml-3"
//                                             src="https://uploads-ssl.webflow.com/6449bec445e2b41c675ec13d/6449bec445e2b477425ec822_Star.svg"
//                                             alt=""
//                                         />
//                                     </span>{" "}
//                                 </h1>
